...
namespace ADOExport.Data
{
    internal static class SqlDataProvider
    {
        ...
        internal static void AddWorkItems(List<WorkItemDetailsDto> data)
        {
        ...
        internal static void AddEmployees(List<TeamMemberDto> data)
        {
            using var connection = new SqlConnection(ConnectionString);
            connection.Open();
        ...
        internal static void ClearWorkItems(List<WorkItemDetailsDto> data)
        {
            using var connection = new SqlConnection(ConnectionString);
            connection.Open();
        ...
        internal static void ClearIterations(List<IterationDto> data)
        {
            using var connection = new SqlConnection(ConnectionString);
            connection.Open();
        ...
        internal static void ClearDevCapacity(List<IterationDto> data)
        {
            using var connection = new SqlConnection(ConnectionString);
            connection.Open();
