...
DECLARE @Employee varchar(50) = null
DECLARE @ShowLeads bit = 1
DECLARE @ShowContractors bit = 0
DECLARE @LimitedView bit = 0
DECLARE @FilterTeam varchar(50) = null

DROP TABLE IF EXISTS #Sprints
CREATE TABLE #Sprints (Sprint varchar(200))
INSERT INTO #Sprints(Sprint)VALUES('25-06')
